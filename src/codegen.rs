use crate::{parser::{NodeExpr, NodeIfStmt, NodeNumber, NodeOperation, NodeScope, NodeScopeItem, NodeStmt, NodeSubIfStmt, NodeValue, AbstractSyntaxTree}, tokenizer::VarName};
...
//        match &statement {
//            NodeStmt::DeclarationStmt(VarName(varname), expr) => {
//                self.gen_expr(expr);
//                self.create_var(varname.to_string());
//            }
//            NodeStmt::AssignmentStmt(VarName(varname), expr) => {
//                self.gen_expr(expr);
